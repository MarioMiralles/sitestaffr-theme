...
$showcase_voices    = array(
	array( 'name' => 'Marin',   'file' => 'marin',   'personality' => 'Warm & Welcoming',    'description' => 'Makes your callers feel right at home with a friendly, inviting tone that puts people at ease. Perfect for service businesses that prioritize customer comfort.',       'bestFor' => 'Home Services | Hospitality | Customer Support',        'plan' => 'Starter',  'recommended' => true ),
	...
	array( 'name' => 'Echo',    'file' => 'echo',    'personality' => 'Calm & Reassuring',   'description' => 'A gentle, soothing presence that helps callers feel heard and supported. Ideal for healthcare and support services.',                                                   'bestFor' => 'Clinics | Wellness Practices | Care Teams',             'plan' => 'Pro',      'recommended' => false ),
